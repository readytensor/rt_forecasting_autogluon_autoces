# AutoCES Time-series Forecaster Model - AutoGluon

AutoCES Forecaster for the Forecasting problem category as per Ready Tensor specifications.
...
- A **AutoCES Forecaster** algorithm built using **AutoGluon**
